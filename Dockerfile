...
# This sets the working directory inside the container to the root folder. This is where the application code will be copied and where subsequent commands will be executed.
WORKDIR /
...
# This copies the entire root directory from the host to the the root directory inside the container. The src directory likely contains your application code and files.
COPY ./ .
